    ...
    <div className={className}>
      <div className="flex gap-2 mb-2 relative">
        <input
          ...
          className="flex-1 px-3 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 bg-background text-foreground"
